...
$app->post('/api/Robin/getOrganizationUsers', function ($request, $response) {
    ...
    $optionalParams = ['query'=>'query','page'=>'page','perPage'=>'per_page','ids'=>'ids'];
    $bodyParams = ['query','page','per_page','ids'];
